...
public class DefaultVisualStudioProjectEx extends AbstractBuildableModelElement implements VisualStudioProject {
    ...
    DefaultVisualStudioProjectEx(String name, NativeComponentSpec component, FileResolver fileResolver, Instantiator instantiator) {
        this.name = name
