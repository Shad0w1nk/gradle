...
public class VisualStudioProjectRegistryEx extends DefaultNamedDomainObjectSet<DefaultVisualStudioProject> {
    private final FileResolver fileResolver;
    private final VisualStudioProjectMapper projectMapper;

    public VisualStudioProjectRegistryEx(FileResolver fileResolver, VisualStudioProjectMapper projectMapper, Instantiator instantiator) {
