...
public class VisualStudioProjectRegistry extends AbstractNamedDomainObjectContainer<DefaultVisualStudioProject> {
...
//    }
    ...
    @Override
    protected DefaultVisualStudioProject doCreate(String name) {
        return getInstantiator().newInstance(DefaultVisualStudioProject.class, name, fileResolver, getInstantiator());
    }
}
