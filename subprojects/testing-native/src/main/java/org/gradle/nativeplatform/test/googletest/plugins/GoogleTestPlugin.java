...
public class GoogleTestPlugin implements Plugin<Project> {
    ...
    static class Rules extends RuleSource {
        ...
        @Mutate
        public void registerGoogleTestFrameworkForEachNativeComponent(CollectionBuilder<ComponentSpec> components, final ProjectSourceSet projectSourceSet, final ServiceRegistry serviceRegistry) {
            components.beforeEach(NativeComponentSpec.class, new Action<NativeComponentSpec>() {
                @Override
                public void execute(final NativeComponentSpec nativeComponentSpec) {
                    ((DefaultTestSuiteContainer) ((ComponentSpecInternal) nativeComponentSpec).getTestSuites()).registerFactory(GoogleTestTestSuiteSpec.class, new NamedDomainObjectFactory<GoogleTestTestSuiteSpec>() {
                        @Override
                        public GoogleTestTestSuiteSpec create(String name) {
                            Instantiator instantiator = serviceRegistry.get(Instantiator.class);
                            FileResolver fileResolver = serviceRegistry.get(FileResolver.class);
                            return createGoogleTestTestSuite(name, nativeComponentSpec, instantiator, projectSourceSet, fileResolver);
                        }

                        private GoogleTestTestSuiteSpec createGoogleTestTestSuite(String suiteName, final NativeComponentSpec testedComponent, Instantiator instantiator, ProjectSourceSet projectSourceSet, FileResolver fileResolver) {
        ...
        private DefaultGoogleTestTestSuiteBinary createTestBinary(ServiceRegistry serviceRegistry, GoogleTestTestSuiteSpec googleTestTestSuite, NativeBinarySpec testedBinary) {
            ...
            return DefaultGoogleTestTestSuiteBinary.create(googleTestTestSuite, (NativeBinarySpecInternal) testedBinary, namingScheme, resolver, instantiator);
        }
